...
export default function HatMark({ className = "h-7 w-7" }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true" focusable="false">
      <g stroke="#3e3a35" strokeWidth={2.6} strokeLinejoin="round" strokeLinecap="round">
        <path d="M20.5 36c-2.5-11-.5-18.5 2.5-20.5 2.2-1.5 4.4 1.5 9 1.5s6.8-3 9-1.5c3 2 5 9.5 2.5 20.5z" fill="#c4a463" />
      ...
      <circle cx="43.6" cy="34.4" r="2.1" fill="#c3a261" stroke="#3e3a35" strokeWidth={1.5} />
    </svg>
  );
}
